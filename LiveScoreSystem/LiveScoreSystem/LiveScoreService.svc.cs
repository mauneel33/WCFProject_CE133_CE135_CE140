...
namespace LiveScoreSystem
{
    public class LiveScoreService : ILiveScoreService
    {
        ...
        public double updateBall(int batteamid, int bowlteamid, int strikerid, int nonstrikerid, int bowlerid, int runonball, int balltype, int wickettype)
        {
        ...
        public void updateEndTime(DateTime endtime, int matchid)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(ConString))
